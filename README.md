<h1 align="center">The Stanley Parable RTX Remix Compatibility Mod</h1>
...
RTX Remix was never intented to support The Stanley Parable.  
...
## Installation / Usage
- Download the latest [release](https://github.com/Asphaltian/tsp-rtx/releases) and follow instructions found __there__.

<br>

#### ✳️ Info: 
- Take a look at the [Wiki](https://github.com/Asphaltian/tsp-rtx/wiki/Compatibility-Mod-Feature-Guide) for in-depth guides on features that come with the compatibility mod
...
for The Stanley Parable (`bin/.trex/d3d9.dll`)
...
for The Stanley Parable (`bin/.trex/NvRemixBridge.exe` & `bin/d3d9.dll`)
...
1. No, copy all of the commandline arguments of the batch file (everything after `START stanley.exe`)
   
2. Add them as launch args by right clicking The Stanley Parable in Steam -> Properties -> Launch Options
...
- Run `toggle-tsp-rtx.bat` and follow the instructions to disable or enable the mod
...
- If your game is installed within `Program Files`:
  - right click `stanley.exe` and click settings - compatibility tab and enable run as admin
  - or install the game somewhere outside `Program Files`

- Other startup issues?
  - Add `-debug` as a launch arg to `run-tsp-rtx.bat` (`START stanley.exe -debug -insecure ...`)
...
<details><summary>Graphics issues - Darkness</summary>
<br>

- Make sure that you installed the [base-remix-mod](https://github.com/Asphaltian/tsp-rtx-base-mod) as stated in the release notes
...
- Either copy `_master.cache` from `root/thestanleyparable/maps/soundcache` to `root/thestanleyparable/maps/soundcache` 
...
- Other Issue?
> - Look at [Closed Issues](https://github.com/Asphaltian/tsp-rtx/issues?q=is%3Aissue+is%3Aclosed) or [Discussions](https://github.com/Asphaltian/tsp-rtx/discussions) to see if people had similar issues
